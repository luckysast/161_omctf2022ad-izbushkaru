...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatNoMatches: function () {
            return 'Соответсвующих записей не найдено';//'No matching records found';
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn btn-table  btn-default" type="button" name="paginationSwitch" title="%s">',
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-table  btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-table  btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn btn-table  btn-default' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input class="round-search form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        var pageNumber = [
                sprintf('<span class="btn-group %s">',
                    this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                    'dropdown' : 'dropup'),
                '<button type="button" class="btn btn-table  btn-default ' +
    ...
    BootstrapTable.prototype.showRow = function (params) {
        ...
        this.toggleRow(params.index, params.isIdField !== undefined, true);
    };
    ...
    BootstrapTable.prototype.hideRow = function (params) {
        ...
        this.toggleRow(params.index, params.isIdField !== undefined, false);
    };
